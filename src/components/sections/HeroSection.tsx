...
import HeroCanvas, { MobileHeroCanvas } from "@/components/3d/HeroCanvas";
    ...
    <section className="relative w-full min-h-[calc(100vh-5rem)] flex flex-col md:flex-row items-center justify-between px-6 md:px-24 bg-transparent">
      ...
      <div className="z-10 w-full md:w-5/12 flex flex-col gap-5 md:gap-6 relative pt-8 md:pt-0">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Mini 3D character beside name — mobile only */}
      ...
      {/* 3D Viewport Column */}
      <div className="hidden md:flex relative md:absolute md:inset-0 z-10 w-full md:w-7/12 h-[50vh] min-h-[350px] md:h-screen md:left-[41.666%] items-center justify-center mt-8 md:mt-0">
        <HeroCanvas />
